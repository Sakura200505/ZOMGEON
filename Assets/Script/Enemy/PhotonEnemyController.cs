...
public class PhotonEnemyController : MonoBehaviourPun, IPunObservable
{
    [Header("設定")]
    ...
    private PhotonGameManager gameManager;
    ...
    void Start()
    {
        ...
        if (gmObj != null)
        {
            gameManager = gmObj.GetComponent<PhotonGameManager>();
        }
